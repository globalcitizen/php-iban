...
The parser was built using regular expressions to adapt the contents of the _official_ IBAN registry available from SWIFT at http://www.swift.com/solutions/messaging/information_products/directory_products/iban_format_registry/index.page then only manually modified for special cases such as [https://php-iban.googlecode.com/git/trunk/docs/COMEDY-OF-ERRORS errors and omissions in SWIFT's official specifications].
 ...
 * Resolve [https://code.google.com/p/php-iban/issues/detail?id=19 issue #19]: incorrect SEPA status of France/French territories due to a parser bug. (Thanks to the reporter)
...
== News: June 2013 ==
*Version 1.4.1* is still being prepared, squashing some bugs and updating the registry ... meanwhile, it has come to my attention that we have been featured in the [http://www.codecandies.com/2012/05/30/no-exceptions/ Code Candy blog]! Hooray for the German sense of humour! Hahah.
 ...
 * [http://code.google.com/p/php-iban/source/diff?spec=svn62&r=61&format=side&path=/trunk/registry.txt&old_path=/trunk/registry.txt&old=57 Registry updates]
...
*[http://code.google.com/p/php-iban/downloads/list php-iban version 12] has been released*.  The registry file has been improved ([http://code.google.com/p/php-iban/source/diff?spec=svn12&r=12&format=side&path=/trunk/registry.txt&old_path=/trunk/registry.txt&old=11 view changes]) partly as a result of user reports and partly as a result of issues uncovered while performing automated tests against [http://code.google.com/p/php-iban/downloads/list?can=4&q=revision+11&colspec=Filename+Summary+Uploaded+Size+DownloadCount version 11].
